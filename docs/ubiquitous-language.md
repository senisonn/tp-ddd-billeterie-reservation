...
|-------|-------------------------------|-------------------------------|
| Événement | Un spectacle, concert ou représentation programmé à une date et un lieu précis. Un événement possède une capacité maximale déterminée par la salle et une politique tarifaire associée. | Le concert de Jazz du 15 mars 2025 à la Grande Salle est un événement avec une capacité de 500 places. |
| Salle | Un lieu physique disposant d'une capacité d'accueil et d'un plan de places organisé en zones et catégories. Chaque salle a une configuration fixe qui détermine les places disponibles. | La Grande Salle dispose de 500 places réparties en Orchestre (300) et Balcon (200). |
| Place | Un emplacement physique identifié dans une salle, caractérisé par une zone, une rangée et un numéro. Une place possède une catégorie qui détermine son tarif de base. | La place A12 en zone Orchestre, rangée A, est une place de catégorie Premium. |
| Catégorie | Un regroupement tarifaire de places selon leur emplacement et leur qualité de visibilité. Chaque catégorie définit un tarif de base qui sert de référence pour le calcul du prix final. | La catégorie « Orchestre » a un tarif de base de 45 € pour le concert de Jazz. |
| Réservation | L'acte par lequel un spectateur réserve une ou plusieurs places pour un événement donné. Une réservation passe par plusieurs statuts : en attente, confirmée, annulée, remboursée. Elle est identifiée par un numéro unique. | La réservation RES-2025-00142 de Marie pour 2 places au concert de Jazz est au statut « Confirmée ». |
| Billet | Un titre d'accès nominatif associé à une réservation, une place et un événement. Chaque billet possède un QR code unique permettant le contrôle d'accès. Un billet peut être valide, utilisé ou annulé. | Le billet BIL-2025-00283 donne accès à la place A12 pour le concert de Jazz, avec le QR code QR-X7K9M. |
| Spectateur | Une personne qui recherche, réserve et assiste à des événements. Un spectateur possède un compte client avec ses informations personnelles et son historique de réservations. | Marie Dupont, étudiante, est une spectatrice avec le compte CLI-2025-00089. |
...
| Annulation | L'acte par lequel un spectateur ou l'organisation met fin à une réservation ou à un événement. L'annulation par le spectateur est soumise à des conditions (délai, frais). L'annulation d'un événement entraîne le remboursement automatique de toutes les réservations. | Marie annule sa réservation 48h avant le concert, des frais d'annulation de 5 € s'appliquent. |
| Jauge | Le nombre de places restantes disponibles pour un événement à un instant donné. La jauge est mise à jour en temps réel à chaque réservation, annulation ou expiration de panier. | La jauge du concert de Jazz indique 23 places restantes sur 500. |
| ContrôleAccès | Le processus de vérification du billet à l'entrée de l'événement par scan du QR code. Le contrôle vérifie l'authenticité du billet, sa validité pour l'événement du jour et son non-usage préalable. | L'agent scanne le QR code de Marie, le système affiche « Accès autorisé – Place A12 ». |
| Abonnement | Une formule permettant à un spectateur d'accéder à un ensemble d'événements à tarif préférentiel. L'abonnement donne droit à des avantages comme l'accès prioritaire aux préventes et des réductions supplémentaires. | L'abonnement « Saison Jazz 2025 » de Marie lui donne accès à 6 concerts avec 30 % de réduction. |
| Programmation | L'ensemble des événements planifiés pour une période donnée. La programmation est définie par le Responsable Programmation et détermine le calendrier des ventes. | La programmation du premier trimestre 2025 comprend 15 événements dans 3 salles. |
...
| Spectateur | ContexteCompteClient | Gestion du profil et de l'historique |
| Panier | ContexteRéservation | Temporaire, gère la sélection avant paiement |
| Tarif | ContexteTarification | Calculé à partir des règles tarifaires |
...
| ContrôleAccès | ContexteContrôleAccès | Validation physique le jour de l'événement |
| Abonnement | ContexteCompteClient | Formule commerciale avec avantages |
| Programmation | ContexteProgrammation | Vision globale des événements |
